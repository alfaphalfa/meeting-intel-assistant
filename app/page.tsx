...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-notarai-dark flex flex-col">
      {/* Auth Modal */}
      {!isAuthenticated && <AuthModal onAuthComplete={handleAuthComplete} />}

      {/* Header */}
      <header className="border-b border-notarai-gray/30 bg-notarai-dark/95 backdrop-blur-md sticky top-0 z-50 shadow-lg">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="text-center relative">
              ...
              <div className="absolute top-0 right-0 flex items-center gap-2 px-4 py-2 bg-notarai-gray/10 border border-notarai-gray/30 rounded-lg">
                {authMode === "admin" ? (
                  <>
                    ...
                    <span className="text-xs text-notarai-gray">Unlimited</span>
                  </>
                ) : (
                  <>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
              <span className="text-notarai-blue">notar</span>
              <span className="text-white">ai</span>
              <span className="text-notarai-blue">.work</span>
            </h1>
            <div className="mt-4 w-24 h-1 bg-gradient-to-r from-notarai-blue via-notarai-blue to-transparent mx-auto rounded-full"></div>
          </div>
        </div>
      </header>
        ...
        <div className="bg-notarai-dark border border-notarai-gray/30 rounded-xl p-6 sm:p-8 mb-10 hover:border-notarai-gray/50 transition-all duration-300 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-3">
            <div>
              ...
              <p className="text-base text-notarai-gray mt-2 leading-relaxed">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <button
                onClick={loadSample}
                className="flex items-center gap-2 px-3 py-1.5 text-sm bg-notarai-gray/20 hover:bg-notarai-gray/30 text-white rounded-md transition-all duration-200 hover:scale-105"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-sm bg-notarai-gray/20 hover:bg-notarai-gray/30 text-white rounded-md transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
          ...
          <textarea
            ...
            className="w-full h-80 bg-notarai-dark border border-notarai-gray/50 rounded-xl p-5 text-white placeholder-notarai-gray/70 focus:outline-none focus:ring-2 focus:ring-notarai-blue focus:border-transparent resize-none transition-all duration-200 text-base leading-relaxed shadow-inner"
          />
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
            <button
              ...
              className="w-full sm:w-auto px-10 py-4 bg-notarai-blue hover:bg-notarai-blue-dark text-white font-bold text-lg rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 hover:scale-105 disabled:hover:scale-100 shadow-xl hover:shadow-notarai-blue/50"
            >
              {isAnalyzing ? (
                <>
            ...
            <p className="text-xs text-notarai-gray">
              {remainingUses === 0 ? "Demo limit reached. Contact admin for password." : "AI-powered analysis takes 5-15 seconds"}
            </p>
          </div>

          {error && (
            <div className="mt-4 p-4 bg-notarai-blue/20 border border-notarai-blue rounded-lg text-notarai-blue animate-fade-in">
              {error}
            </div>
          )}
        </div>
      ...
      {/* Footer */}
      <footer className="border-t border-notarai-gray/30 bg-notarai-dark/95 backdrop-blur-md mt-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-notarai-gray text-sm leading-relaxed">
              Built with{" "}
              <span className="text-notarai-blue">♥</span>{" "}
              by{" "}
            ...
            <div className="mt-4 flex items-center justify-center gap-6">
              <a
                ...
                className="text-notarai-gray hover:text-notarai-blue transition-colors duration-200 text-sm flex items-center gap-2"
              >
              ...
              <span className="text-notarai-gray/50">•</span>
              <span className="text-notarai-gray text-sm">
